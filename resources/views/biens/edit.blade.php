...
<div class="offset-4"></div>
    ...
    <form method="post" action="{{route('ajout_bien.update',$products->id)}}" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
               <div class="row">
               ...
               <div class="col-md-2 col-xs-2 form">
                    ...
                    <div class="col-md-2 col-xs-2">
                            ...
                            <input type="text" class="form-control rounded-pill" id="validationDefault01" value="{{$products->localisation}}" placeholder="localisation" name="localisation" >
                   ...
                   <div class="col-md-2 col-xs-2">
                             <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                             <input type="number" class="form-control rounded-pill" id="validationDefault01" value="{{$products->toilette}}" placeholder="toilette" name="toilette" >
                   ...
                   <label for="exampleFormControlSelect1"></label>
                    ...
                    <div class="col-md-3 col-xs-3 mt-3">
                             <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                             <input type="number" class="form-control rounded-pill" id="validationDefault01" value="{{$products->prix}}" placeholder="Prix" name="prix" >
                             {!! $errors->first('prix', '<small class="text-danger">:message</small>') !!}
                    </div>

                    <div class="col-md-4 col-xs-4 mt-3">
                             <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                             <input type="text" class="form-control rounded-pill" id="validationDefault01" value="{{$products->description}}" placeholder="Description" name="description" >
                    ...
                    <div class="col-md-4 col-xs-4 mt-3">
                            <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                            <input type="number" class="form-control rounded-pill" id="validationDefault01" value="{{$products->caution}}" placeholder="nombre de mois de caution" name="caution" >
                            {!! $errors->first('caution', '<small class="text-danger">:message</small>') !!}
                   </div>

                   <div class="col-md-4 col-xs-4 mt-3">
                            <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                            <input type="number" class="form-control rounded-pill" id="validationDefault01" value="{{$products->avance}}" placeholder="nombre de mois d'avance" name="avance" >
                            {!! $errors->first('avance', '<small class="text-danger">:message</small>') !!}
                   </div>

                   <div class="col-md-4 col-xs-4 mt-3">
                            <label for="validationDefault01" class="font-weight-bolder blue "> </label>
                            <input type="number" class="form-control rounded-pill" id="validationDefault01" value="{{$products->prestation}}" placeholder="nombre de mois de prestation" name="prestation" >
                    ...
                    <div class="file-upload-content">
                        <img class="file-upload-image" src="{{asset('storage').'/'.$products->picture}}" alt="your image" />
